...
Open-C3 - это автоматизированная платформа с открытым исходным кодом, включающая функции CMDB, системы мониторинга, системы распространения, системы рабочих листов, системы процессов и т. Д. В то же время автоматические связи между подсистемами. Это интегрированная автоматизированная платформа.
